      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="text-center mb-6 fade-in">
          <div className="relative inline-block mb-4">
            ...
            <div className="relative w-20 h-20 mx-auto rounded-2xl flex items-center justify-center shadow-2xl border border-white/10 overflow-hidden bg-surface-8dp">
              <img src="/assets/Logo-new.png" alt="NumaliRide Logo" className="w-16 h-16 object-contain" />
            </div>
          </div>
